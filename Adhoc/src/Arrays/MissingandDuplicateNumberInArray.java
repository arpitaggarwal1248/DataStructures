 ...
 *  Arrays.MissingandDuplicateNumberInArray
 */
package Arrays;
...
public class MissingandDuplicateNumberInArray {
    ...
    public static ArrayList<Integer> repeatedNumber(List<Integer> a) {
        ...
        for (int i = 0; i < n; ++i) {
            temp[a.get((int)i).intValue()] = temp[a.get(i)] == 0 ? 1 : -1;
        }
